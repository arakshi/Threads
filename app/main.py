...
def collect_ui(urls: str = 'demo://sample', keywords: str = 'продажи,маркетинг,бизнес') -> RedirectResponse:
...
def local_ui(msg: str = '', show_guide: int = 0, q: str = '', min_score: float = 0.0) -> str:
    ...
    <div class='guide'>
      <h3>Короткий гайд</h3>
      <ol>
        <li>Добавьте аккаунты и темы.</li>
        <li>Нажмите «Запустить сбор».</li>
        <li>Используйте фильтры по ключевой фразе и минимальной вирусности.</li>
        <li>Изучайте посты и блок статистики.</li>
      </ol>
    </div>
    """ if show_guide else ''
      ...
      <div class='wrap'>
        ...
        <div class='card'>
          ...
          <form action='/app/collect' method='get'>
            <textarea name='urls' rows='3'>https://www.threads.net/@username/post/XXXXXXXXXXX</textarea>
            <input name='keywords' value='продажи,маркетинг,бизнес'>
