...
def local_ui() -> str:
    ...
    <head>
      ...
      <title>Охотник за вирусными Threads — Локальный интерфейс</title>
      <style>
    ...
    <body>
      <div class='wrap'>
        <h1>🧵 Охотник за вирусными Threads</h1>
        <div class='btn-row'>
        ...
        return new Promise(function(resolve, reject){
          ...
          xhr.onreadystatechange = function(){
            ...
            if(xhr.status >= 200 && xhr.status < 300){ resolve(data); }
              ...
              var detail = data && data.detail ? data.detail : ('HTTP ' + xhr.status);
      ...
      setStatus('✅ Интерфейс загружен. Нажмите «📘 Как пользоваться».', true);
      refreshAll();
      </script>
    </body>
    </html>
